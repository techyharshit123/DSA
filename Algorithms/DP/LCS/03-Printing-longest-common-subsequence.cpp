...
string printLCS(int x, int y, string s1, string s2)
{
    ...
    reverse(lcs.begin(), lcs.end()); // this is required as we are moving from bottom right to top left so the resulting string will be in reverse order
